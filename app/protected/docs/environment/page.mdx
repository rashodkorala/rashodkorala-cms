...
Required for AI-powered photo analysis:
...
<Alert variant="info">
  ...
  <AlertDescription>
    Get your API key from [OpenAI Platform](https://platform.openai.com/api-keys). See the [AI Analysis guide](/protected/docs/features/ai-analysis) for more details.
  </AlertDescription>
</Alert>
